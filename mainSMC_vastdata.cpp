...
for(unsigned int run=1; run<=num_runs; run++){
  ...
  SMCobj = new SMC_PP_MCMC(start,end,num_intervals,max_iterations,max_iterations,nu,0,ppptr,num_of_individuals,dovariable,calculate_intensity,0,SMCMC,0,seed);
