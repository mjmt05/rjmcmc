...
OBJS=argument_options.o argument_options_smc.o RJMCMC_PP.o SMC_PP_MCMC_nc.o probability_model.o Poisson_process_model.o SNCP.o histogram.o mc_divergence.o changepoint.o function_of_interest.o step_function.o rejection_sampling.o
HEADERS=decay_function.hpp univariate_function.hpp RJMCMC.hpp particle.hpp SMC_PP.hpp Data.hpp histogram_type.hpp

.PHONY: clean

all: mainRJ_example mainSMC_example test_rejection_sampling

mainRJ_example: mainRJ_example.cpp $(OBJS) #$(HEADERS)

mainSMC_example: mainSMC_example.cpp $(OBJS)#$(HEADERS)

test_rejection_sampling: test_rejection_sampling.cpp $(OBJS)
