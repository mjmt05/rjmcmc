...
void ArgumentOptionsSMC::usage(int status,char * programname){
  ...
  cerr << programname << " --model sncp --intervals 40 --particles 500 --movewidth 5 --cpprior .0025 --modelprior1 $(echo '2.0/3.0' | bc -l) --modelprior2 .01 --grid 1000 --essthreshold 0.4  --writeess  shot_noise.txt 0 2000" << endl;
  cerr << endl;
